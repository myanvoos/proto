...
```bash
bun .proto/skills/tool-prompt-optimization/scripts/probe.ts \
...
```bash
bun .proto/skills/tool-prompt-optimization/scripts/probe-builtin.ts --tool <name> [--no-summary] [--show]
```

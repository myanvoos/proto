 ...
 *
 * We impersonate external tools (Gemini CLI, Claude Code, Codex) via User-Agent
 * and client-version strings. When these tools release new versions, the upstream service may start

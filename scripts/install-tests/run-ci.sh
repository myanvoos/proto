...
#    handled separately).
for pkg in utils omptype hashline catalog ai agent tui; do
   (
...
(
   ...
   bun add "$utils_tgz" "$omptype_tgz" "$natives_tgz" "$hashline_tgz" "$catalog_tgz" "$ai_tgz" "$agent_tgz" "$tui_tgz" "$coding_agent_tgz"

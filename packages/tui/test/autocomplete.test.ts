...
describe("CombinedAutocompleteProvider", () => {
	...
	describe("absolute path completion", () => {
		...
		it("triggers automatic completion for a drive-letter path token", async () => {
			// On POSIX `C:` is a relative directory literally named `C:`, created
			// here so the same drive-style token exercises the trigger without
			// platform branching downstream.

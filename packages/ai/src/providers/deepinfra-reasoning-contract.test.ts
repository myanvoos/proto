...
import type { AssistantMessage, Context, FetchImpl, Model, ThinkingContent, ToolCall } from "../types";
import { convertMessages, streamOpenAICompletions } from "./openai-completions";
...
describe("DeepInfra reasoning wire contract", () => {

...
/**
 * Ceiling on the output-token count proto requests from any OpenAI-family endpoint
...
export interface StreamOptions {
	 ...
	 * requests across local PROTO processes that share the same config root. Omitted

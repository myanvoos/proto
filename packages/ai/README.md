...
Authenticate via the [`proto`](https://github.com/myanvoos/proto) coding-agent CLI, which drives this library's OAuth/API-key flows in-process and persists into `agent.db`:

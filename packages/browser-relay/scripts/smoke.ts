/**
 * Manual end-to-end smoke for the relay: replicates the proto browser tool's
...
/** Puppeteer keeps the CDP target id on an internal field; same access the proto tab supervisor uses (`targetIdForPage`). */

...
export function getExtraHelpText(): string {
  ...
  PROTO_PROFILE                 - Named profile for isolated agent state (same as --profile)
  Use \`proto --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  proto agents unpack           - Export bundled subagents to ~/.proto/agent/agents (default)
  proto agents unpack --project - Export bundled subagents to ./.proto/agents`;
}

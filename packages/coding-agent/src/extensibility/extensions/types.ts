...
import type { BashToolDetails, BashToolInput, ReadToolDetails, ReadToolInput, WriteToolInput } from "../../tools";
...
export interface ExtensionContext {
	 ...
	 *
	 * PROTO has no equivalent per-directory trust gate: `.proto/extensions`, `.proto/config.yml`, and
	 ...
	 * and always returns `true`, truthfully reflecting that PROTO already trusts project-local inputs
	 * by default -- it does not narrow or widen PROTO's own security model.
	 */

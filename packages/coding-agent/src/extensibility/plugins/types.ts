// =============================================================================
// Plugin Manifest Types (from package.json proto/pi field)
// =============================================================================
...
/**
 * Plugin manifest from package.json proto or pi field.
 */
...
// =============================================================================
// Runtime Config Types (stored in proto-plugins.lock.json)
// =============================================================================
...
/**
 * Runtime configuration persisted to proto-plugins.lock.json.
...
/**
 * Project-local plugin overrides (stored in .proto/plugin-overrides.json).

...
Managed skills: `SKILL.md` in isolated `~/.proto/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.proto/agent/skills` or `.proto/skills`.

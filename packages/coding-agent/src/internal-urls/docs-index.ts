/**
 * Harness documentation index for the `proto://` protocol.
 *
...
/** Empty index for when no docs corpus is reachable — degrades `proto://` instead of throwing ENOENT at callers. */

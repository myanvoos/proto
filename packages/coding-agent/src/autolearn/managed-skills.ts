 ...
 * isolated directory (`~/.proto/agent/managed-skills`) separate from
 * user-authored skills (`~/.proto/agent/skills`). They are discovered and
...
export const MANAGED_SKILLS_PROVIDER_ID = "proto-managed";
...
/** Resolve the isolated managed-skills directory (`~/.proto/agent/managed-skills`). */

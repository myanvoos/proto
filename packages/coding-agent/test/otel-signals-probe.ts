...
await Bun.sleep(700);
await flushTelemetryExport();
assertSingleMetricPoint("pi.proto.agent.chat.calls");
assertSingleMetricPoint("pi.proto.agent.tool.calls");
assertSingleMetricPoint("pi.proto.agent.tool.duration");
await server.stop(true);

...
import { nativeBlockResolver } from "@oh-my-pi/pi-coding-agent/edit/hashline/block-resolver";
 ...
 * suites still see the real tree-sitter — mock.module("@oh-my-pi/pi-natives") is

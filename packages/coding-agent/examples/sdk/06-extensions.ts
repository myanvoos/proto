 ...
 * - ~/.proto/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.proto/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.proto/agent/extensions/ or .proto/extensions/

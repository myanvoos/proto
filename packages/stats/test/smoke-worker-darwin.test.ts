...
import { smokeTestSyncWorker } from "@oh-my-pi/proto-stats/aggregator";
...
describe("smokeTestSyncWorker", () => {
	it("skips the worker spawn on darwin so proto --smoke-test stays off the macOS abort surface", async () => {

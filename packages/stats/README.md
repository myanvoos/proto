# @oh-my-pi/proto-stats

Local observability dashboard for AI usage statistics.

## Features

- **Session log parsing**: Reads JSONL session logs from `~/.proto/agent/sessions/`
...
```typescript
import { getDashboardStats, syncAllSessions } from "@oh-my-pi/proto-stats";
...
- **Session logs**: `~/.proto/agent/sessions/` (JSONL files)
- **Stats database**: `~/.proto/stats.db` (SQLite)

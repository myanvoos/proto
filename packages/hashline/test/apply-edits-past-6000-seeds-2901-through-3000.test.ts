/**
 * Seeded walks for seeds 2901..3000: 50 ops each. Crosses 3000 seed band.
 */
...
describe("applyEdits past 6000 seeds 2901 through 3000", () => {
	for (const seed of seedBand(2901, 3000)) {
		it(`seed=${seed}`, () => {

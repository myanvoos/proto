/**
 * Seeded walks for seeds 1401..1500: 40 ops each. Crosses 1500 seed band.
 */
...
describe("applyEdits past 6000 seeds 1401 through 1500", () => {
	for (const seed of seedBand(1401, 1500)) {
		it(`seed=${seed}`, () => {

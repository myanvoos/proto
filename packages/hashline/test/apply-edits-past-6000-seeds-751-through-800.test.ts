/**
 * Seeded walks for seeds 751..800: 20 ops each including PRE inserts.
 * Why: LCG band after 701-750; PRE path not exercised in every seed suite.
 */
...
describe("applyEdits past 6000 seeds 751 through 800", () => {
	for (const seed of seedBand(751, 800)) {
		it(`seed=${seed}`, () => {

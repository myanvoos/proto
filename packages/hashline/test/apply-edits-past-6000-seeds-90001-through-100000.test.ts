/**
 * Seeded walks for seeds 90001..100000: 50 ops each (10000 seeds). Crosses 100000 seed band.
 */
...
describe("applyEdits past 6000 seeds 90001 through 100000", () => {
	for (const seed of seedBand(90001, 100000)) {
		it(`seed=${seed}`, () => {

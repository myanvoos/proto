/**
 * Seeded walks for seeds 19001..20000: 50 ops each (1000 seeds). Crosses 20000 seed band.
 */
...
describe("applyEdits past 6000 seeds 19001 through 20000", () => {
	for (const seed of seedBand(19001, 20000)) {
		it(`seed=${seed}`, () => {

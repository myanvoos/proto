/**
 * Seeded walks for seeds 1400001..1500000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 1400001 through 1500000", () => {
	for (const seed of seedBand(1400001, 1500000)) {
		it(`seed=${seed}`, () => {

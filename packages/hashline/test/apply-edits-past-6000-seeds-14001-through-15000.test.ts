/**
 * Seeded walks for seeds 14001..15000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 14001 through 15000", () => {
	for (const seed of seedBand(14001, 15000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 4801..5000: 50 ops each. Crosses 5000 seed band.
 */
...
describe("applyEdits past 6000 seeds 4801 through 5000", () => {
	for (const seed of seedBand(4801, 5000)) {
		it(`seed=${seed}`, () => {

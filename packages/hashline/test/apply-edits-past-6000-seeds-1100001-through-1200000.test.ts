/**
 * Seeded walks for seeds 1100001..1200000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 1100001 through 1200000", () => {
	for (const seed of seedBand(1100001, 1200000)) {
		it(`seed=${seed}`, () => {

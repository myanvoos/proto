/**
 * Seeded walks for seeds 40001..45000: 50 ops each (5000 seeds).
 */
...
describe("applyEdits past 6000 seeds 40001 through 45000", () => {
	for (const seed of seedBand(40001, 45000)) {
		it(`seed=${seed}`, () => {

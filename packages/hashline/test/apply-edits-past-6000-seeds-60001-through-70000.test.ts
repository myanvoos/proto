/**
 * Seeded walks for seeds 60001..70000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 60001 through 70000", () => {
	for (const seed of seedBand(60001, 70000)) {
		it(`seed=${seed}`, () => {

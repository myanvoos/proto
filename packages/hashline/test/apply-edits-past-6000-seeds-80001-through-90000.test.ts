/**
 * Seeded walks for seeds 80001..90000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 80001 through 90000", () => {
	for (const seed of seedBand(80001, 90000)) {
		it(`seed=${seed}`, () => {

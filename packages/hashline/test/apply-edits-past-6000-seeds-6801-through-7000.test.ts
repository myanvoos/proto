/**
 * Seeded walks for seeds 6801..7000: 50 ops each. Crosses 7000 seed band.
 */
...
describe("applyEdits past 6000 seeds 6801 through 7000", () => {
	for (const seed of seedBand(6801, 7000)) {
		it(`seed=${seed}`, () => {

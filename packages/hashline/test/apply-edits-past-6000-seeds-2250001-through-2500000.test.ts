/**
 * Seeded walks for seeds 2250001..2500000: 50 ops each. Crosses seed band past 2M.
...
describe("applyEdits past 6000 seeds 2250001 through 2500000", () => {
	for (const seed of seedBand(2250001, 2500000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 2750001..3000000: 50 ops each. Crosses seed band past 2M.
...
describe("applyEdits past 6000 seeds 2750001 through 3000000", () => {
	for (const seed of seedBand(2750001, 3000000)) {
		it(`seed=${seed}`, () => {

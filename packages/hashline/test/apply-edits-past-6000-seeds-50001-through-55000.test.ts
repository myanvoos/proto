/**
 * Seeded walks for seeds 50001..55000: 50 ops each (5000 seeds).
 */
...
describe("applyEdits past 6000 seeds 50001 through 55000", () => {
	for (const seed of seedBand(50001, 55000)) {
		it(`seed=${seed}`, () => {

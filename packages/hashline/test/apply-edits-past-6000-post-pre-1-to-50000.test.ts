/**
 * INS.POST / INS.PRE at anchor a for a bounded sample of a in 1..50000 on n=50000.
 * Sampled, not the full 1..50000 sweep: one applyEdits per anchor is O(n), so the
...
describe("applyEdits past 6000 POST PRE 1 to 50000", () => {
	const n = 50000;

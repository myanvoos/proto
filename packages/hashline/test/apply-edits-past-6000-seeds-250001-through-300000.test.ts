/**
 * Seeded walks for seeds 250001..300000: 50 ops each (50000 seeds). Crosses 300000 seed band.
 */
...
describe("applyEdits past 6000 seeds 250001 through 300000", () => {
	for (const seed of seedBand(250001, 300000)) {
		it(`seed=${seed}`, () => {

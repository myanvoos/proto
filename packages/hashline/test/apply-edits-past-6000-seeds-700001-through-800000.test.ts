/**
 * Seeded walks for seeds 700001..800000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 700001 through 800000", () => {
	for (const seed of seedBand(700001, 800000)) {
		it(`seed=${seed}`, () => {

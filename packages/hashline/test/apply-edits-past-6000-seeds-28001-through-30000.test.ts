/**
 * Seeded walks for seeds 28001..30000: 50 ops each (2000 seeds). Crosses 30000 seed band.
 */
...
describe("applyEdits past 6000 seeds 28001 through 30000", () => {
	for (const seed of seedBand(28001, 30000)) {
		it(`seed=${seed}`, () => {

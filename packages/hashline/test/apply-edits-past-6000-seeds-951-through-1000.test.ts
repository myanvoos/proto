/**
 * Seeded walks for seeds 951..1000: 30 ops each. Crosses 1000 seed band.
 */
...
describe("applyEdits past 6000 seeds 951 through 1000", () => {
	for (const seed of seedBand(951, 1000)) {
		it(`seed=${seed}`, () => {

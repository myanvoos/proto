/**
 * Seeded walks for seeds 140001..150000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 140001 through 150000", () => {
	for (const seed of seedBand(140001, 150000)) {
		it(`seed=${seed}`, () => {

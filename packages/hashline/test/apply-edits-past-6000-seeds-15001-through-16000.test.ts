/**
 * Seeded walks for seeds 15001..16000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 15001 through 16000", () => {
	for (const seed of seedBand(15001, 16000)) {
		it(`seed=${seed}`, () => {

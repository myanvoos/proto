/**
 * Seeded walks for seeds 130001..140000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 130001 through 140000", () => {
	for (const seed of seedBand(130001, 140000)) {
		it(`seed=${seed}`, () => {

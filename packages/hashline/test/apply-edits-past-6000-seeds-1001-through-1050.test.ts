/**
 * Seeded walks for seeds 1001..1050: 30 ops each past the 1000 band.
 */
...
describe("applyEdits past 6000 seeds 1001 through 1050", () => {
	for (const seed of seedBand(1001, 1050)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 175001..200000: 50 ops each (25000 seeds). Crosses 200000 seed band.
 */
...
describe("applyEdits past 6000 seeds 175001 through 200000", () => {
	for (const seed of seedBand(175001, 200000)) {
		it(`seed=${seed}`, () => {

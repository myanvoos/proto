/**
 * Seeded walks for seeds 1300001..1400000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 1300001 through 1400000", () => {
	for (const seed of seedBand(1300001, 1400000)) {
		it(`seed=${seed}`, () => {

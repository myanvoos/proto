/**
 * Seeded walks for seeds 13001..14000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 13001 through 14000", () => {
	for (const seed of seedBand(13001, 14000)) {
		it(`seed=${seed}`, () => {

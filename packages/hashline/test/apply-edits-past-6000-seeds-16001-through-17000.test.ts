/**
 * Seeded walks for seeds 16001..17000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 16001 through 17000", () => {
	for (const seed of seedBand(16001, 17000)) {
		it(`seed=${seed}`, () => {

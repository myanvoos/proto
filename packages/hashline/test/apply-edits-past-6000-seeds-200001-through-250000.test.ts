/**
 * Seeded walks for seeds 200001..250000: 50 ops each (50000 seeds).
 */
...
describe("applyEdits past 6000 seeds 200001 through 250000", () => {
	for (const seed of seedBand(200001, 250000)) {
		it(`seed=${seed}`, () => {

/**
 * DEL prefix 1..=k and suffix (n-k+1).=n for k=1..60 on n=60.
 * Why: exact remaining slices for both ends of the file.
 */
import { describe, expect, it } from "bun:test";
import { applyEdits, parsePatch } from "@oh-my-pi/hashline";

describe("applyEdits past 6000 DEL prefix and suffix k 1 to 60", () => {
	const n = 60;

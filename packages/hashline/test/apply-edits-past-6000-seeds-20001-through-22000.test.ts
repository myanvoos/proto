/**
 * Seeded walks for seeds 20001..22000: 50 ops each (2000 seeds).
 */
...
describe("applyEdits past 6000 seeds 20001 through 22000", () => {
	for (const seed of seedBand(20001, 22000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 120001..130000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 120001 through 130000", () => {
	for (const seed of seedBand(120001, 130000)) {
		it(`seed=${seed}`, () => {

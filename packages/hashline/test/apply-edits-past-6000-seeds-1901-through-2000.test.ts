/**
 * Seeded walks for seeds 1901..2000: 45 ops each. Crosses 2000 seed band.
 */
...
describe("applyEdits past 6000 seeds 1901 through 2000", () => {
	for (const seed of seedBand(1901, 2000)) {
		it(`seed=${seed}`, () => {

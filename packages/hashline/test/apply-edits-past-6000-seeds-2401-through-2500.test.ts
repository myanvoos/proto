/**
 * Seeded walks for seeds 2401..2500: 50 ops each. Crosses 2500 seed band.
 */
...
describe("applyEdits past 6000 seeds 2401 through 2500", () => {
	for (const seed of seedBand(2401, 2500)) {
		it(`seed=${seed}`, () => {

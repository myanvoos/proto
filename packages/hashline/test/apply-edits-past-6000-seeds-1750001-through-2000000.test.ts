/**
 * Seeded walks for seeds 1750001..2000000: 50 ops each (250000 seeds). Crosses 2M seed band.
 */
...
describe("applyEdits past 6000 seeds 1750001 through 2000000", () => {
	for (const seed of seedBand(1750001, 2000000)) {
		it(`seed=${seed}`, () => {

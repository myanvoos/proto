/**
 * Seeded walks for seeds 45001..50000: 50 ops each (5000 seeds). Crosses 50000 seed band.
 */
...
describe("applyEdits past 6000 seeds 45001 through 50000", () => {
	for (const seed of seedBand(45001, 50000)) {
		it(`seed=${seed}`, () => {

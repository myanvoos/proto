/**
 * Seeded walks for seeds 17001..18000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 17001 through 18000", () => {
	for (const seed of seedBand(17001, 18000)) {
		it(`seed=${seed}`, () => {

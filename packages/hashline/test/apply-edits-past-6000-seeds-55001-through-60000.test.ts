/**
 * Seeded walks for seeds 55001..60000: 50 ops each (5000 seeds). Crosses 60000 seed band.
 */
...
describe("applyEdits past 6000 seeds 55001 through 60000", () => {
	for (const seed of seedBand(55001, 60000)) {
		it(`seed=${seed}`, () => {

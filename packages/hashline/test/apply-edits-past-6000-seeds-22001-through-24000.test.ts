/**
 * Seeded walks for seeds 22001..24000: 50 ops each (2000 seeds).
 */
...
describe("applyEdits past 6000 seeds 22001 through 24000", () => {
	for (const seed of seedBand(22001, 24000)) {
		it(`seed=${seed}`, () => {

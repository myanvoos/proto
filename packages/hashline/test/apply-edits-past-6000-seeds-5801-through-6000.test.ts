/**
 * Seeded walks for seeds 5801..6000: 50 ops each. Crosses 6000 seed band.
 */
...
describe("applyEdits past 6000 seeds 5801 through 6000", () => {
	for (const seed of seedBand(5801, 6000)) {
		it(`seed=${seed}`, () => {

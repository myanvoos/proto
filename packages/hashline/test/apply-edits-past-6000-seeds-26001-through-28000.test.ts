/**
 * Seeded walks for seeds 26001..28000: 50 ops each (2000 seeds).
 */
...
describe("applyEdits past 6000 seeds 26001 through 28000", () => {
	for (const seed of seedBand(26001, 28000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 24001..26000: 50 ops each (2000 seeds).
 */
...
describe("applyEdits past 6000 seeds 24001 through 26000", () => {
	for (const seed of seedBand(24001, 26000)) {
		it(`seed=${seed}`, () => {

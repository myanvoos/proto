/**
 * Seeded walks for seeds 110001..120000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 110001 through 120000", () => {
	for (const seed of seedBand(110001, 120000)) {
		it(`seed=${seed}`, () => {

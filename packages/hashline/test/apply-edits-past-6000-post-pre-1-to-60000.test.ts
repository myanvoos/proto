/**
 * INS.POST / INS.PRE at anchor a for a bounded sample of a in 1..60000 on n=60000.
 * Sampled, not the full 1..60000 sweep: one applyEdits per anchor is O(n), so the

/**
 * Seeded walks for seeds 30001..35000: 50 ops each (5000 seeds).
 */
...
describe("applyEdits past 6000 seeds 30001 through 35000", () => {
	for (const seed of seedBand(30001, 35000)) {
		it(`seed=${seed}`, () => {

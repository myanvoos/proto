/**
 * Seeded walks for seeds 600001..700000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 600001 through 700000", () => {
	for (const seed of seedBand(600001, 700000)) {
		it(`seed=${seed}`, () => {

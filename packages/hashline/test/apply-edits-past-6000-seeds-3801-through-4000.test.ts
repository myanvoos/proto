/**
 * Seeded walks for seeds 3801..4000: 50 ops each (200 seeds). Crosses 4000 seed band.
 */
...
describe("applyEdits past 6000 seeds 3801 through 4000", () => {
	for (const seed of seedBand(3801, 4000)) {
		it(`seed=${seed}`, () => {

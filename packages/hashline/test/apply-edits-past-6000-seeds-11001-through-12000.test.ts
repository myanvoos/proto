/**
 * Seeded walks for seeds 11001..12000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 11001 through 12000", () => {
	for (const seed of seedBand(11001, 12000)) {
		it(`seed=${seed}`, () => {

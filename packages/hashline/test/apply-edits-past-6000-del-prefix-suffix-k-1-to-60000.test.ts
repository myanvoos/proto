/**
 * DEL prefix (1.=k) and suffix ((n-k+1).=n) for a bounded sample of k in 1..60000
 * on n=60000. Sampled, not the full 1..60000 sweep: one applyEdits per k is O(n), so
...
describe("applyEdits past 6000 DEL prefix suffix k 1 to 60000", () => {
	const n = 60000;

/**
 * Seeds 3000501..3002000: 50 ops each (post-3M band continue).
 */
...
describe("applyEdits past 6000 seeds 3000501 through 3002000", () => {
	for (const seed of seedBand(3000501, 3002000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 500001..600000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 500001 through 600000", () => {
	for (const seed of seedBand(500001, 600000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 2000001..2250000: 50 ops each. Crosses seed band past 2M.
...
describe("applyEdits past 6000 seeds 2000001 through 2250000", () => {
	for (const seed of seedBand(2000001, 2250000)) {
		it(`seed=${seed}`, () => {

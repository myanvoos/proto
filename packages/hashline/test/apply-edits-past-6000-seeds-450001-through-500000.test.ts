/**
 * Seeded walks for seeds 450001..500000: 50 ops each (50000 seeds). Crosses 500000 seed band.
 */
...
describe("applyEdits past 6000 seeds 450001 through 500000", () => {
	for (const seed of seedBand(450001, 500000)) {
		it(`seed=${seed}`, () => {

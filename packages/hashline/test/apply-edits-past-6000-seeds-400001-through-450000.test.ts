/**
 * Seeded walks for seeds 400001..450000: 50 ops each (50000 seeds).
 */
...
describe("applyEdits past 6000 seeds 400001 through 450000", () => {
	for (const seed of seedBand(400001, 450000)) {
		it(`seed=${seed}`, () => {

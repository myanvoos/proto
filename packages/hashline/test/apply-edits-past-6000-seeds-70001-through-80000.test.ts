/**
 * Seeded walks for seeds 70001..80000: 50 ops each (10000 seeds).
 */
...
describe("applyEdits past 6000 seeds 70001 through 80000", () => {
	for (const seed of seedBand(70001, 80000)) {
		it(`seed=${seed}`, () => {

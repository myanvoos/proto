/**
 * Seeded walks for seeds 18001..19000: 50 ops each (1000 seeds).
 */
...
describe("applyEdits past 6000 seeds 18001 through 19000", () => {
	for (const seed of seedBand(18001, 19000)) {
		it(`seed=${seed}`, () => {

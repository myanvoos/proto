/**
 * Seeded walks for seeds 800001..900000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 800001 through 900000", () => {
	for (const seed of seedBand(800001, 900000)) {
		it(`seed=${seed}`, () => {

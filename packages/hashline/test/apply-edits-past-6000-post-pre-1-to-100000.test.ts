/**
 * INS.POST / INS.PRE at anchor a for a bounded sample of a in 1..100000 on n=100000.
 * Sampled, not the full 1..100000 sweep: one applyEdits per anchor is O(n), so the
 * full sweep is O(n^2) (~10^10) and blows the 5s per-test and
...
describe("applyEdits past 6000 POST PRE 1 to 100000", () => {
	const n = 100000;

/**
 * Seeded walks for seeds 9501..10000: 50 ops each (500 seeds). Crosses 10000 seed band.
 */
...
describe("applyEdits past 6000 seeds 9501 through 10000", () => {
	for (const seed of seedBand(9501, 10000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 1500001..1750000: 50 ops each (250000 seeds).
 */
...
describe("applyEdits past 6000 seeds 1500001 through 1750000", () => {
	for (const seed of seedBand(1500001, 1750000)) {
		it(`seed=${seed}`, () => {

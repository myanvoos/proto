/**
 * Seeded walks for seeds 900001..1000000: 50 ops each (100000 seeds). Crosses 1M seed band.
 */
...
describe("applyEdits past 6000 seeds 900001 through 1000000", () => {
	for (const seed of seedBand(900001, 1000000)) {
		it(`seed=${seed}`, () => {

/**
 * Seeded walks for seeds 1200001..1300000: 50 ops each (100000 seeds).
 */
...
describe("applyEdits past 6000 seeds 1200001 through 1300000", () => {
	for (const seed of seedBand(1200001, 1300000)) {
		it(`seed=${seed}`, () => {

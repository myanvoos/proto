...
const QWEN_37_BUDGETS: ThinkingConfig = {
	...
	defaultLevel: Effort.High,
	requiresEffort: false,
	// Cline's 10/20/50/80/95/100% effort ratios over the 131,072-token output ceiling.
	effortBudgets: {
...
// ClinePass metadata published by Cline CLI 3.0.58 / @cline/llms 0.0.79. The recommended-models endpoint
// stays authoritative for membership; this snapshot supplies the limits, plan pricing, and reasoning
// controls it omits.
